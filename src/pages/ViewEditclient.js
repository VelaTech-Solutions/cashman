  ...
  return (
    <div className="p-8 bg-gray-900 text-white min-h-screen">
      ...
      <nav className="flex space-x-4 bg-gray-800 p-4 rounded-lg shadow-md">
        ...
        <Link to="/viewclient" className="text-white hover:text-blue-400 transition">Back to Client List</Link>
      </nav>

      {/* Client Profile and Edit Section */}
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mt-8">
        <h1 className="text-4xl font-bold mb-4 text-blue-400">View/Edit Client</h1>

        <div className="bg-gray-900 p-4 rounded-lg shadow-sm">
          <h2 className="text-2xl font-semibold text-white">Edit Client Details</h2>
        ...
        {clientData && (
          <div className="bg-gray-900 p-4 rounded-lg shadow-md mt-8">
            ...
            <p className="text-lg text-gray-400 mt-2">
              <strong className="text-white">Captured By:</strong> {clientData.userEmail || 'N/A'}
            </p>
            <p className="text-lg text-gray-400">
              <strong className="text-white">Date Captured:</strong> {clientData.dateCaptured || 'N/A'}
            </p>
            <p className="text-lg text-gray-400">
              <strong className="text-white">Last Updated:</strong> {clientData.lastUpdated || 'N/A'}
            </p>
          </div>
        )}
      </div>
