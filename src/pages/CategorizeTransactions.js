    ...
    <div className="min-h-screen flex bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white">
      ...
      >
        ...
        <nav className="space-y-4 border-t border-gray-700 pt-4">
          ...
          <Link 
            //to="/modifyknowntransactions" still need to create page
            className="flex items-center space-x-3 hover:text-white transition">
            Modify Known Transactions
            <i className="ph-check-square text-xl"></i>
          </Link>
        </nav>
      </motion.div>
      ...
      <div className="flex-1 p-8">
        ...
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-blue-400">Categorize Transactions</h1>
        </header>
        ...
        <section className="bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              <p className="text-lg font-bold text-blue-400">Total Transactions Categorized </p>
            ...
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-3xl font-bold text-white">{/* Placeholder for what? */}0</p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              <p className="text-lg font-bold text-blue-400">????</p>
              <p className="text-3xl font-bold text-white">{/* Placeholder for what? */}0</p>
            ...
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              <p className="text-lg font-bold text-blue-400">Known Categorized Transactions</p>
              <p className="text-3xl font-bold text-white">{/* Placeholder for what? */}0
