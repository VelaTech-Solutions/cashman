      ...
      <div className="flex-1 p-8">
        ...
        <section className="space-y-4">
          ...
          >
            ...
            <span className="ml-4 bg-green-500 text-white px-2 py-1 rounded text-sm">
              {transactions.filter((txn) => txn.credit_amount && (txn.category === "Income" || !txn.category)).length} incomes
            </span>
          </h2>
          ...
          {showIncome && transactions.filter((txn) => txn.credit_amount && (txn.category === "Income" || !txn.category)).length > 0 ? (
                  ...
                  {transactions
                    ...
                    .map((txn, index) => (
                      <tr key={index} className="hover:bg-gray-700">
                        <td className="px-4 py-2">{txn.date1}</td>
                        <td className="px-4 py-2">{txn.description}</td>
                        <td className="px-4 py-2">{txn.category || "Not Available"}</td>
            ...
            showIncome && (
              <p className="text-center text-lg text-gray-500">No income transactions found.</p>
            )
          )}
        </section>
        ...
        >
          ...
          <span className="ml-4 bg-blue-500 text-white px-2 py-1 rounded text-sm">
            {transactions.filter((txn) => txn.debit_amount && txn.category === "Savings").length} savings
          </span>
        </h2>
        ...
        {showSavings && transactions.filter((txn) => txn.debit_amount && txn.category === "Savings").length > 0 ? (
          <div className="overflow-y-auto max-h-64 bg-gray-800 rounded-md shadow-lg">
            <table className="min-w-full table-auto text-left text-white">
              <thead className="bg-gray-700">
                <tr>
          ...
          showSavings && (
            <p className="text-center text-lg text-gray-500">No savings transactions found.</p>
          )
        )}
        </section>
        ...
        <section className="space-y-4">
          ...
          {/* Scrollable Transactions List */}
          {showHousing && transactions.filter((txn) => txn.debit_amount && txn.category === "Housing").length > 0 ? (
            <div className="overflow-y-auto max-h-64 bg-gray-800 rounded-md shadow-lg">
              <table className="min-w-full table-auto text-left text-white">
                <thead className="bg-gray-700">
                  <tr>
            ...
            showHousing && (
            <p className="text-center text-lg text-gray-500">No housing transactions found.</p>
            )
          )}
        </section>
        ...
        <section className="space-y-4">
          ...
          {/* Scrollable Transactions List */}
          {showTransportation && transactions.filter((txn) => txn.debit_amount && txn.category === "Transportation").length > 0 ? (
            <div className="overflow-y-auto max-h-64 bg-gray-800 rounded-md shadow-lg">
              <table className="min-w-full table-auto text-left text-white">
                <thead className="bg-gray-700">
                  <tr>
            ...
            showTransportation && (
            <p className="text-center text-lg text-gray-500">No transportation transactions found.</p>
            )
          )}
        </section>
        ...
        <section className="space-y-4">
          ...
          >
            ...
            <span className="ml-4 bg-red-500 text-white px-2 py-1 rounded text-sm">
              {transactions.filter((txn) => txn.debit_amount && txn.category === "Expenses").length} Expenses
            </span>
          </h2>
          ...
          {/* Scrollable Transactions List */}
          {showExpenses && transactions.filter((txn) => txn.debit_amount && txn.category === "Expenses").length > 0 ? (
            <div className="overflow-y-auto max-h-64 bg-gray-800 rounded-md shadow-lg">
              <table className="min-w-full table-auto text-left text-white">
                <thead className="bg-gray-700">
                  <tr>
            ...
            showExpenses && (
              <p className="text-center text-lg text-gray-500">No expenses transactions found.</p>
            )
          )}
        </section>
