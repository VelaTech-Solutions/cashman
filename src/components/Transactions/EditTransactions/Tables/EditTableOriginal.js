...
return (
    <div>
        <h1 className="text-sm font-semibold mb-4">Valid</h1>
        <p className="text-gray-400">Vaild Transactions</p>

        <BaseTable headers={headers} rows={rows} />
        <p className="mt-4 text-gray-400">
          Valid transactions: {filteredTransactions.length}
        </p>
    </div>
    );
};
