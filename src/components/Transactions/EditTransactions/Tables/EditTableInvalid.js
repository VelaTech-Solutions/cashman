...
return (
    <div>
        <h1 className="text-sm font-semibold mb-4">Invalid</h1>
        <p className="text-gray-400">Transactions with missing date or amount</p>
        ...
        Invalid transactions: {filteredTransactions.length}
        </p>
    </div>
    );
};
