...
const extractDates = async (clientId, bankName, type) => {
  ...
  try {
    ...
    // inside the bankOptions in config there type is name like typeA or typeB
    // but the type comes in like TypeA or TypeB
    // the field we need from the settings is dateRegex
