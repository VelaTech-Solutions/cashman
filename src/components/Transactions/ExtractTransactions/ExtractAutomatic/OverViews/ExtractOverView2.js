// src/components/Transactions/ExtractTransactions/ExtractAutomatic/OverViews/ExtractOverView2.js
import React from "react";

const ExtractOverView2 = ({ transactions = [] }) => {
...
export default ExtractOverView2;
