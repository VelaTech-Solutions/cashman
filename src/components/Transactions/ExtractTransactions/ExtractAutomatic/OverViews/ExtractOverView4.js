// src/components/Transactions/ExtractTransactions/ExtractAutomatic/OverViews/ExtractOverView4.js
import React from "react";

const ExtractOverView4 = ({ transactions = [] }) => {
...
export default ExtractOverView4;
