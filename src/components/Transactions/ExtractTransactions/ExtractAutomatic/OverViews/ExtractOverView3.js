// src/components/Transactions/ExtractTransactions/ExtractAutomatic/OverViews/ExtractOverView3.js
import React from "react";

const ExtractOverView3 = ({ transactions = [] }) => {
...
export default ExtractOverView3;
