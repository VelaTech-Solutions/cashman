...
// from or start The Standard Bank of South Africa Limited

// to or end Date Description Payments Deposits Balance

export default function HeaderFooterFilter() {
  ...
  const configDoc = (bank) => doc(db, "settings", "headerFooterFilter", bank, "config");

  const fieldsConfig = [
    { key: 'headerFooterFilterEnabled', label: 'Enable Header Footer Extraction', type: 'boolean' },
    { key: 'headerStart', label: 'Enter Header Start', type: 'string' },
    { key: 'headerEnd', label: 'Enter Header End', type: 'string' }
  ];
