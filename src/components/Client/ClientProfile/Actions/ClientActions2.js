        ...
        <div className="flex flex-wrap gap-3 mb-4 items-center justify-center">
          ...
          {actionLinks.map(({ label, path }) => (
            <Link
              key={path}
              to={path}
              className="relative bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-cyan-500 hover:to-blue-600 text-white py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-blue-500/40 shadow-md"
            >
              {label}
            </Link>
          ))}
          ...
          {/* Delete Button */}
          <button
            className="bg-gradient-to-r from-red-500 to-orange-500 hover:from-orange-500 hover:to-red-600 text-white py-3 px-6 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-110 hover:shadow-red-500/40 shadow-md"
            onClick={() => {
