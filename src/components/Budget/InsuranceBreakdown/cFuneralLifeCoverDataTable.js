...
const CFuneralLifeCoverDataTable = ({ transactions = [] }) => {
  const maxRows = 14;
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    while (slicedTransactions.length < maxRows) {
      slicedTransactions.push({ c_flc_institution: "", type: "", amount: "" });
    }
...
export default CFuneralLifeCoverDataTable;
