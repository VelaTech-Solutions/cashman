...
const RShortTermInsuranceDataTable = ({ transactions }) => {
  const maxRows = 14;
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    while (slicedTransactions.length < maxRows) {
      slicedTransactions.push({ r_sti_institution: "", type: "", amount: "" });
    }
...
export default RShortTermInsuranceDataTable;