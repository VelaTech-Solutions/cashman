...
const CShortTermInsuranceDataTable = ({ transactions = [] }) => {
  const maxRows = 14;
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    while (slicedTransactions.length < maxRows) {
      slicedTransactions.push({ c_sti_institution: "", type: "", amount: "" });
    }
...
export default CShortTermInsuranceDataTable;
