...
const CSavingsInvestmentsDataTable = ({ transactions = [] }) => {
  const maxRows = 14;
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    while (slicedTransactions.length < maxRows) {
      slicedTransactions.push({ c_si_institution: "", type: "", amount: "" });
    }
...
export default CSavingsInvestmentsDataTable;
