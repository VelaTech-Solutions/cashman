...
const RFuneralLifeCoverDataTable = ({ transactions }) => {
  const maxRows = 14;
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    while (slicedTransactions.length < maxRows) {
      slicedTransactions.push({ r_flc_institution: "", r_flc_type: "", r_flc_amount: "" });
    }
...
export default RFuneralLifeCoverDataTable;